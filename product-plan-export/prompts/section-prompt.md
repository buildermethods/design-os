...
- **SECTION_NAME** = [Human-readable name, e.g., "Today" or "Leads"]
- **SECTION_ID** = [Folder name in sections/, e.g., "today" or "leads"]
...
1. **@product-plan-export/product-overview.md** — Product summary for overall context
2. **@product-plan-export/instructions/incremental/NN-SECTION_ID.md** — Specific instructions for this section

Also review the section assets:
- **@product-plan-export/sections/SECTION_ID/README.md** — Feature overview and design intent
- **@product-plan-export/sections/SECTION_ID/tests.md** — Test-writing instructions (use TDD approach)
- **@product-plan-export/sections/SECTION_ID/components/** — React components to integrate
- **@product-plan-export/sections/SECTION_ID/types.ts** — TypeScript interfaces
- **@product-plan-export/sections/SECTION_ID/sample-data.json** — Test data
