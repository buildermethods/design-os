...
1. **@product-plan-export/product-overview.md** — Product summary with sections and data model overview
2. **@product-plan-export/instructions/one-shot-instructions.md** — Complete implementation instructions for all milestones

After reading these, also review:
- **@product-plan-export/design-system/** — Color and typography tokens
- **@product-plan-export/data-model/** — Entity types and relationships
- **@product-plan-export/shell/** — Application shell components
- **@product-plan-export/sections/** — All section components, types, sample data, and test instructions
