...
- `product-plan-export/sections/dashboard/tests.md`

## What to Implement

### Components

Copy components from `product-plan-export/sections/dashboard/components/`:
- `DashboardView.tsx`
- `FilterBar.tsx`
- `FunnelCard.tsx`
- `DropReasonChart.tsx`
...
- `product-plan-export/sections/dashboard/README.md` — Feature overview
- `product-plan-export/sections/dashboard/tests.md` — Test instructions
- `product-plan-export/sections/dashboard/components/` — React components
- `product-plan-export/sections/dashboard/types.ts` — TypeScript interfaces
- `product-plan-export/sections/dashboard/sample-data.json` — Sample data
- `product-plan-export/sections/dashboard/dashboard.png` — Visual reference
